    ...
    <SafeAreaView style={styles.screen}>
      ...
      <Modal visible={Boolean(selected)} animationType="slide" transparent onRequestClose={closeDetail}>
        ...
        {selected && <View style={styles.detailSheet}>
          ...
          {selected.photoUrl ? <Pressable accessibilityRole="button" accessibilityLabel={`Expand verified restroom photo for ${selected.name}`} onPress={() => setExpandedPhoto(selected.photoUrl!)} style={styles.photoHero}><Image source={{ uri: selected.photoUrl }} style={styles.verifiedPhoto} resizeMode="cover" /><View style={styles.photoHeroOverlay}><View><Text style={styles.photoTitleLight}>Verified restroom photo</Text><Text style={styles.photoCopyLight}>Tap to view full size</Text></View><Text style={styles.expandGlyph}>↗</Text></View></Pressable> : <View style={styles.photoNotice}><Text style={styles.photoIcon}>▧</Text><View style={styles.photoNoticeText}><Text style={styles.photoTitle}>No verified interior photo yet</Text><Text style={styles.photoCopy}>Help the next person: submit a restroom-only photo after your visit.</Text></View></View>}
      ...
      <Modal visible={Boolean(expandedPhoto)} animationType="fade" transparent onRequestClose={() => setExpandedPhoto(null)}>
        <Pressable style={styles.photoViewerBackdrop} onPress={() => setExpandedPhoto(null)}>
          <Pressable accessibilityLabel="Close expanded photo" style={styles.photoViewerClose} onPress={() => setExpandedPhoto(null)}><Text style={styles.photoViewerCloseText}>×</Text></Pressable>
          {expandedPhoto ? <Image source={{ uri: expandedPhoto }} style={styles.expandedPhoto} resizeMode="contain" /> : null}
...
const styles = StyleSheet.create({
  ...
  photoNotice: { flexDirection: 'row', alignItems: 'center', gap: 12, backgroundColor: '#F2F0E8', borderRadius: 14, padding: 12, marginTop: 18 }, photoNoticeText: { flex: 1 }, photoHero: { width: '100%', height: 220, borderRadius: 16, overflow: 'hidden', marginTop: 18, backgroundColor: '#D7DED7' }, verifiedPhoto: { width: '100%', height: '100%' }, photoHeroOverlay: { position: 'absolute', left: 0, right: 0, bottom: 0, minHeight: 62, paddingHorizontal: 15, paddingVertical: 11, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', backgroundColor: 'rgba(11,34,28,.74)' }, photoTitleLight: { color: '#FFFEFA', fontWeight: '900', fontSize: 14 }, photoCopyLight: { color: '#DCE8E0', fontSize: 11, marginTop: 2 }, expandGlyph: { color: '#FFFEFA', fontSize: 24, fontWeight: '800' }, photoViewerBackdrop: { flex: 1, backgroundColor: 'rgba(5,17,14,.94)', alignItems: 'center', justifyContent: 'center', padding: 18 }, expandedPhoto: { width: '100%', height: '82%' }, photoViewerClose: { position: 'absolute', top: Platform.OS === 'ios' ? 54 : 24, right: 22, zIndex: 2, width: 44, height: 44, borderRadius: 22, alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(255,255,255,.14)' }, photoViewerCloseText: { color: '#FFFFFF', fontSize: 30, lineHeight: 34 }, photoViewerHint: { color: '#C7D4CC', fontSize: 12, fontWeight: '700', marginTop: 8 }, photoIcon: { fontSize: 22, color: '#C95B34' }, photoTitle: { color: '#274239', fontWeight: '800', fontSize: 13 }, photoCopy: { color: '#617168', fontSize: 12, lineHeight: 17, marginTop: 2, maxWidth: 290 }, gptLeadTag: { backgroundColor: '#F6E8D8', paddingHorizontal: 9, paddingVertical: 6, borderRadius: 20 }, gptLeadTagText: { fontSize: 10, letterSpacing: .6, color: '#96501F', fontWeight: '900' }, detailActions: { flexDirection: 'row', gap: 10, marginTop: 19 }, directions: { flex: 1, backgroundColor: '#173F38', borderRadius: 13, alignItems: 'center', paddingVertical: 14 }, directionsText: { color: '#FFFDF7', fontWeight: '900', fontSize: 14 }, update: { flex: .65, borderWidth: 1, borderColor: '#173F38', borderRadius: 13, alignItems: 'center', paddingVertical: 14 }, updateText: { color: '#173F38', fontWeight: '900', fontSize: 14 },
